...
class _LoginPageState extends State<LoginPage> {
                ...
                child: Form(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const Text(
                            "Dale pa' aca, no pierdas la comunicacion con tus compañeros",
                            style: TextStyle(
                        ...
                        TextFormField(
                          ...
                          validator: (val) {
                            if (val!.length < 8) {
                              return "La contraseña debe tenere al menos 8 caracteres";
                            } else {
                              return null;
                            }
                          },
  ...
  login() async {
    if (formKey.currentState!.validate()) {
      ...
      await authService
          .loginWithNameAndPassword(email, password)
          .then((value) async {
        if (value == true) {
